...
implements Serializable {
    ...
    public static ImmutableLongArray of(long first, long ... rest) {
        ...
        array[0] = first;
        System.arraycopy((Object)rest, 0, (Object)array, 1, rest.length);
    ...
    public static final class Builder {
        ...
        public Builder addAll(long[] values) {
            ...
            System.arraycopy((Object)values, 0, (Object)this.array, this.count, values.length);
        ...
        public Builder addAll(ImmutableLongArray values) {
            this.ensureRoomFor(values.length());
            System.arraycopy((Object)values.array, values.start, (Object)this.array, this.count, values.length());
            this.count += values.length();
            return this;
        }
        ...
        private void ensureRoomFor(int numberToAdd) {
            ...
            if (newCount > this.array.length) {
                ...
                System.arraycopy((Object)this.array, 0, (Object)newArray, 0, this.count);
                this.array = newArray;
            }
        }
